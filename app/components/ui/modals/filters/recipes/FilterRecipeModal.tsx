...
import { RecipeFilter } from '../../../../../types/recipe.types'

interface FilterRecipeModalProps {
	visible: boolean
	onClose: () => void
...
const FilterRecipeModal: React.FC<FilterRecipeModalProps> = ({
	visible,
	onClose,
	onApply,
	initialFilter
	...
	const toggleFilter = (key: keyof RecipeFilter) => {
	...
	const handleReset = () => {
		const resetFilter: RecipeFilter = {
			highProtein: false,
			lowCalorie: false,
			highCalorie: false,
			lowCarb: false,
		...
		>
			<View style={styles.modalOverlay}>
				<View style={styles.modalContainer}>
					<Text style={styles.modalTitle}>Фильтры рецептов</Text>
